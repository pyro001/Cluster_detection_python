...
def locwatershed(img_org, thresh2, modifier=1.9):
    ...
    if l < 50 and b < 50:
        zoom = True
        img = cv2.resize(img, (0, 0), fx=watersheadScalar, fy=watersheadScalar)
        thresh2 = cv2.resize(thresh2, (0, 0), fx=watersheadScalar, fy=watersheadScalar)
